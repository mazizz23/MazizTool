...
- **Registry Scanner** — full registry scan: auto-start entries, Winlogon, IFEO, AppInit_DLLs, Explorer policies, browser hijacks, SafeMode, disabled security tools
...
- **Startup Manager** — registry + folder + scheduled task auto-start entries
